...
export class HomePageComponent implements OnInit, OnDestroy {
  ...
  public line_ChartOptions = {
    ...
    hAxis: {
      format: 'd. MMM',
      baselineColor: '#1D2E3B',
      gridlines: {count: 10, color: '#1D2E3B', opacity: 0.13},
  ...
  public line_ChartOptions2 = {
    ...
    hAxis: {
      format: 'd. MMM',
      baselineColor: '#f7faff',
      gridlines: {count: 10, color: '#f7faff', opacity: 0.13},
      minorGridlines: {color: 'f7faff'},
